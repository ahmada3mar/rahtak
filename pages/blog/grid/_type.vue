		...
		<nav class="breadcrumb-nav">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item">
						<nuxt-link :to='localePath("/blog/classic")'>Blog</nuxt-link>
					</li>
