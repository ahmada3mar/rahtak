<template>
    <main class="main">
        <page-header title="Buttons" subtitle="Elements"></page-header>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Rounded Corners Style</span>
                            <a href="javascript:;" class="btn btn-outline-primary btn-rounded">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Round Style</span>
                            <a href="javascript:;" class="btn btn-outline-primary btn-round">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="row">
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Rounded Corners Style</span>
                            <a href="javascript:;" class="btn btn-outline-dark btn-rounded">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Round Style</span>
                            <a href="javascript:;" class="btn btn-outline-dark btn-round">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="row">
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Rounded Corners Style</span>
                            <a href="javascript:;" class="btn btn-primary btn-rounded btn-shadow">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Square Style</span>
                            <a href="javascript:;" class="btn btn-primary btn-shadow">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-6 col-lg-4 col-xl-2">
                        <div class="btn-wrap">
                            <span>Round Style</span>
                            <a href="javascript:;" class="btn btn-primary btn-round btn-shadow">
                                <span>Button text</span>
                                <i class="icon-long-arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="javascript:;" class="btn btn-link btn-link-dark">
                            <span>Button Text</span>
                            <i class="icon-long-arrow-right"></i>
                        </a>
                        <a href="javascript:;" class="btn btn-link btn-link-dark">
        ...
        <parallax
            ...
            class="bg-image bg-overlay pt-5 pb-6 mb-5"
        >
            <div class="container">
                <div class="row">
                    <div class="col-6 col-lg-4 col-xl-2">
