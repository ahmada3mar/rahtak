                            ...
                            <div class="card card-box bg-light">
                                <div class="card-header" id="heading4-1">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[3][0], collapsed: !toggleState[3][0]}"
                            ...
                            <div class="card card-box bg-light">
                                <div class="card-header" id="heading4-2">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[3][1], collapsed: !toggleState[3][1]}"
                            ...
                            <div class="card card-box bg-light">
                                <div class="card-header" id="heading4-3">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[3][2], collapsed: !toggleState[3][2]}"
                            ...
                            <div class="card card-box card-sm bg-white">
                                <div class="card-header" id="heading6-1">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[5][0], collapsed: !toggleState[5][0]}"
                            ...
                            <div class="card card-box card-sm bg-white">
                                <div class="card-header" id="heading6-2">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[5][1], collapsed: !toggleState[5][1]}"
                            ...
                            <div class="card card-box card-sm bg-white">
                                <div class="card-header" id="heading6-3">
                                    <h2 class="card-title">
                                        <a
                                            class="toggle-button"
                                            :class="{expanded: toggleState[5][2], collapsed: !toggleState[5][2]}"
