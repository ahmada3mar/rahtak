<template>
    <main class="main">
        <page-header title="Call to Action" subtitle="Elements"></page-header>
        ...
        <div class="page-content pb-5">
            <div class="container">
                ...
                <div
                    ...
                    v-lazy:background-image="'./images/backgrounds/cta/bg-1.jpg'"
                >
                ...
                <h2 class="title text-center mb-5">
                    Newsletter Banner
                    <span class="title-separator">/</span> With Dark Background
                </h2>
            </div>

            <parallax
                class="cta bg-image bg-dark pt-6 pb-7 mb-5"
            ...
            <div class="container">
                <h2 class="title text-center mb-5">
                    Newsletter Banner
                    <span class="title-separator">/</span> Without Background
                </h2>
                ...
                <h2 class="title text-center mb-5">
                    Call to Action
                    <span class="title-separator">/</span> Newsletter Banner
                    <span class="title-separator">/</span> With Background
                </h2>

                <div
                    class="cta cta-separator bg-image mb-5"
                    style="background-position: center right;"
                    v-lazy:background-image="'./images/backgrounds/cta/bg-5.jpg'"
                >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="cta-wrapper cta-text text-center">
                                <h3
                                    class="cta-title"
                                >Morbi in sem quis dui placerat pellentesque felis.</h3>
                ...
                <h2 class="title text-center mb-5">
                    Call to Action
                    <span class="title-separator">/</span> Newsletter Banner
                    <span class="title-separator">/</span> No Background
                </h2>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div
                            class="cta bg-image mb-3"
                            style="background-position: center right;"
                            v-lazy:background-image="'./images/backgrounds/cta/bg-3.jpg'"
                        >
                            <div class="cta-wrapper cta-text text-center">
                                <h3
                                    class="cta-title"
                    ...
                    <div class="col-lg-6">
                        <div
                            class="cta bg-image mb-3"
                            style="background-position: center right;"
                            v-lazy:background-image="'./images/backgrounds/cta/bg-4.jpg'"
                        >
                            <div class="cta-wrapper text-center">
                                <h3 class="cta-title">Join Our Newsletter</h3>
            ...
            <div class="container">
                ...
                <div
                    class="cta bg-image pt-6 pb-7 mb-5"
                    style="background-position: center right;"
                    v-lazy:background-image="'./images/backgrounds/cta/bg-2.jpg'"
                >
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-8 col-lg-6">
            ...
            <parallax
                class="cta bg-image bg-dark pt-6 pb-7"
                :bg-image="'./images/backgrounds/bg-large.jpg'"
            >
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-8 col-lg-6">
                            <div class="cta-text text-center">
                                <h3
                                    class="cta-title text-white"
                                >Morbi in sem quis dui placerat felis.</h3>
