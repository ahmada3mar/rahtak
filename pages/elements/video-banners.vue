<template>
    <main class="main">
        <page-header title="Video Banners" subtitle="Elements"></page-header>
        ...
        <div class="page-content">
            ...
            <div
                ...
                v-lazy:background-image="'./images/video/bg-1.jpg'"
            >
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <h3 class="video-banner-title h3">
                                <span class="text-primary">New Video</span>Womens New Arrivals
                            </h3>
                        ...
                        <div class="col-md-6">
                            <div class="video-poster">
                                <img v-lazy="'./images/video/poster-1.jpg'" alt="poster" />
            ...
            <div
                class="video-banner bg-image text-center pt-8 pb-8"
                v-lazy:background-image="'./images/video/bg-2.jpg'"
            >
                <div class="container">
                    <div class="row">
                        <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
                            <div class="video-poster">
                                <img v-lazy="'./images/video/poster-2.jpg'" alt="poster" />
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <div class="video-box-content">
                                    <h3 class="video-banner-title h1">
                                        <span class="text-primary">New Video</span>
                            ...
                            <div class="col-md-6">
                                <div class="video-poster">
                                    <img v-lazy="'./images/video/poster-3.jpg'" alt="poster" />
